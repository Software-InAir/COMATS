...
class LowWaterTest(QWidget):
    ...
    def __init__(self, instrument_worker: InstrumentWorker | None = None, parent=None):
        ...
        self.lowwater_passed = [False, False, False, False, False, False]
        self.lowwater_failed = [False, False, False, False, False, False]
    ...
    def LowWater(self):
        try:
            ...
            # Completed
                    ...
                    msg1.setText("The Low Water test has been completed successfully.")
