...
#--------------------------------------------------------------------------------- Creation/Edit Menu Buttons
    ...
    def RunIndividualTests(self):
        ...
        if not hasattr(self, "api_base_url"):
            self.api_base_url = "http://comats:8000"
        if not hasattr(self, "current_test_id"):
            self.current_test_id = None
        ...
        try:
            ...
            print(f"Created test_run with ID {self.current_test_id}")
        ...
        if modelNumber == "11225-1":
            try:
                ...
                print("[MainWindow] Passed context to VisualInspection")
                ...
                print("[MainWindow] Passed context to Low Water")
                ...
                print("[MainWindow] Passed context to Water Leaks")
                ...
                print("[MainWindow] Passed context to Heater Current")
                ...
                print("[MainWindow] Passed context to Hot Water Light")
                ...
                print("[MainWindow] Passed context to BrewBE")
...
##############################################################################---- See if 11225 actually includes watertemp/ambienttemp
                ...
                print("[MainWindow] Passed context to Temperature")
                ...
                print("[MainWindow] Passed context to Ambient Temperature")
                ...
                print("[MainWindow] Passed context to Heated Water")
                ...
                print("[MainWindow] Passed context to UnHeated Water")
                ...
                print("[MainWindow] Passed context to Lamp")
                ...
                print("[MainWindow] Passed context to Hot Plate")
                ...
                print("[MainWindow] Passed context to Power Interrupt")
                ...
                print("[MainWindow] Passed context to IRED Monitor")
                ...
                print("[MainWindow] Passed context to Pressure Relief Valve")
