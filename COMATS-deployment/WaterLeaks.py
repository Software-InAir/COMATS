...
class WaterLeaksTest(QWidget):
    ...
    def __init__(self, instrument_worker: InstrumentWorker | None = None, tabs: QTabWidget | None = None, parent=None):
        ...
        self.waterleaks_passed = [False, False]
        self.waterleaks_failed = [False, False]
    ...
    def WaterLeaksResults(self):
        ...
        try:
            ...
            if r.status_code == 404:
                QMessageBox.information(self, "No Results", "WaterLeaks has not been run yet.")
                return
        ...
        step_labels = {
            "step1_waterleaks_pressure": "Water Pressure Test (PSIG):",
            "step2_waterleaks_leak": "Water Leaks Inspection Test:",
        }

        ordered_keys = [
            "step1_waterleaks_pressure",
            "step2_waterleaks_leak",
        ]
        ...
        col_width = 68
        report_lines = []
        report_lines.append("Water Leaks Test")
        ...
        # ---------- Show window ----------
        win = QMainWindow(self)
        win.setWindowTitle("WaterLeaks Results")
        win.resize(750, 520)
        ...
        self._waterleaks_results_window = win
