...
class DielectricTest(QWidget):
        ...
        def DielectricResults(self):
                ...
                try:
                        ...
                        if r.status_code == 404:
                                QMessageBox.information(self, "No Results", "Dielectric has not been run yet.")
                                return
                ...
                step_labels = {
                        "step1_dielectric_hipot_current": "Hi-Pot Leakage Current Test (mA):",
                        "step2_dielectric_megaohm_resistance": "Insulation Resistance Test (MΩ):",
                }

                ordered_keys = [
                        "step1_dielectric_hipot_current",
                        "step2_dielectric_megaohm_resistance",
                ]
                ...
                col_width = 68
                report_lines = []
                report_lines.append("Dielectric Test")
                ...
                # ---------- Show window ----------
                win = QMainWindow(self)
                win.setWindowTitle("Dielectric Results")
                win.resize(750, 520)
                ...
                self._dielectric_results_window = win
