...
class HeaterAndPreheaterTest(QWidget):
    ...
    def HeaterAndPreheaterResults(self):
        ...
        try:
            ...
            if r.status_code == 404:
                QMessageBox.information(self, "No Results", "HeaterAndPreheater has not been run yet.")
                return
        ...
        step_labels = {
            "step1_heaterandpreheater_phasea": "Phase A Heater Current Test (A):",
            "step2_heaterandpreheater_phaseb": "Phase B Heater Current Test (A):",
            "step3_heaterandpreheater_phasec": "Phase C Heater Current Test (A):",
            "step4_heaterandpreheater_time": "Preheat Elapsed Time Test:",
        }

        ordered_keys = [
            "step1_heaterandpreheater_phasea",
            "step2_heaterandpreheater_phaseb",
            "step3_heaterandpreheater_phasec",
            "step4_heaterandpreheater_time",
        ]
        ...
        col_width = 68
        report_lines = []
        report_lines.append("Heater and Preheater Test")
        ...
        # ---------- Build display ----------
        text = "<h2>HeaterAndPreheater Results</h2>"
        ...
        # ---------- Show window ----------
        win = QMainWindow(self)
        win.setWindowTitle("Heater And Preheater Results")
        win.resize(750, 520)
        ...
        self._heaterandpreheater_results_window = win
